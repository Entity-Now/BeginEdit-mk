import { defineAsyncComponent, ref, shallowRef, provide, onMounted, computed, openBlock, createElementBlock, createElementVNode, Fragment, renderList, unref, createBlock, resolveDynamicComponent, withDirectives, isRef, withKeys, vModelText, createCommentVNode, toRefs, mergeProps, renderSlot, normalizeClass, Teleport, withModifiers, vShow } from "vue";
...
var emojies_defs = emoji;
var emojies_shortcuts = shortcuts;
var bare_emoji_plugin = bare;
var light = function emoji_plugin2(md, options) {
  var defaults = {
    defs: emojies_defs,
  ...
  getToolbar() {
    this.toolBar.forEach((item) => {
      let component = defineAsyncComponent(
        () => __variableDynamicImportRuntimeHelper(/* @__PURE__ */ Object.assign({ "../components/Edit/alignment.vue": () => import("./alignment-7362947e.js"), "../components/Edit/bold.vue": () => import("./bold-9eee4368.js"), "../components/Edit/code.vue": () => import("./code-fd5494b0.js"), "../components/Edit/emoji.vue": () => import("./emoji-c0154113.js"), "../components/Edit/header.vue": () => import("./header-a8b8580a.js"), "../components/Edit/html.vue": () => import("./html-1a142a09.js"), "../components/Edit/italic.vue": () => import("./italic-c4ffaa34.js"), "../components/Edit/link.vue": () => import("./link-46b2b0ec.js"), "../components/Edit/list.vue": () => import("./list-dcf4b7a8.js"), "../components/Edit/picture.vue": () => import("./picture-43f24fb1.js"), "../components/Edit/quote-left.vue": () => import("./quote-left-784bcc4c.js"), "../components/Edit/underline.vue": () => import("./underline-674891a6.js"), "../components/Edit/video.vue": () => import("./video-f4a9c47c.js") }), `../components/Edit/${item}.vue`)
      );
...
const _hoisted_1$1 = { class: "BeginEdit-Box" };
const _hoisted_2 = { class: "BeginEdit-header" };
const _hoisted_3 = { class: "BeginEditToolbar" };
const _hoisted_4 = { class: "Begin-Toolbar-list" };
  ...
  setup(__props, { expose, emit: emits }) {
    ...
    const ContentEnterEvent = (event) => {
      ...
      if (lineFeedIndex.match(/^\s*(?:[0-9]+\.|-)\s+\S+/) != null) {
        let list3 = lineFeedIndex.match(/^\s*(?:[0-9]\.|-)\s/).shift();
      ...
      return openBlock(), createElementBlock("div", _hoisted_1$1, [
        createElementVNode("div", _hoisted_2, [
          createElementVNode("div", _hoisted_3, [
            (openBlock(true), createElementBlock(Fragment, null, renderList(unref(ListToolbar), (item) => {
        ...
        createElementVNode("div", _hoisted_5, [
          withDirectives(createElementVNode("textarea", {
            ...
            onKeydown: withKeys(ContentEnterEvent, ["enter"]),
            onKeyup: _cache[1] || (_cache[1] = withKeys((...args) => _ctx.Click_Space && _ctx.Click_Space(...args), ["space"]))
          }, null, 40, _hoisted_6), [
            [vModelText, unref(value)]
          ]),
          BeginEditRenderShow.value ? (openBlock(), createElementBlock("div", {
            key: 0,
...
const _sfc_main = /* @__PURE__ */ Object.assign(__default__, {
  ...
  setup(__props, { emit: emits }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", mergeProps({ class: "BeginToolBarItem" }, _ctx.$attrs), [
        renderSlot(_ctx.$slots, "title", {}, () => [
          createElementVNode("i", {
            title: __props.name,
            class: normalizeClass(["MarkDownIcon", __props.icon]),
